...
describe("Record Store", function(){
  ...
  amoeba = new RecordStore("Amoeba Music", "Los Angeles", 0, 0, 0);
  roughTrade = new RecordStore("Rough Trade", "New York City", 0, 0, 0);
  ...
  it("Should be able to find a record by its title", function(){
    amoeba.add(cameraObscura);
    assert.equal(cameraObscura, amoeba.getTitle('Lets get out of this country'));
  }); 
